...
export const dict = {
  ...
  "connection.guide.subtitle": "服务器不可用。请设置后端以继续。",
  "connection.guide.tab.desktop": "桌面端",
  "connection.guide.tab.android": "安卓端",
  "connection.guide.android.tip": "提示：请从 F-Droid 安装 Termux（不要使用 Play Store，版本较旧）。",
  "connection.guide.step.copy": "复制",
  "connection.guide.step.copied": "已复制！",
  "connection.guide.retry": "重试",
  "connection.guide.footer": "服务器运行在 localhost:4096。启动后页面会自动连接。",
  "connection.guide.step.installBun": "安装 Bun",
  "connection.guide.step.cloneRepo": "克隆仓库",
  "connection.guide.step.enterDir": "进入目录",
  "connection.guide.step.installDeps": "安装依赖",
  "connection.guide.step.startServer": "启动服务器",
  "connection.guide.step.installTermux": "安装 Termux（通过 F-Droid）",
  "connection.guide.step.installTermuxDeps": "打开 Termux 并安装依赖",
