export const dict = {
  ...
  "connection.guide.title": "OpenCode",
  "connection.guide.subtitle": "Server not available. Set up the backend to continue.",
  "connection.guide.tab.desktop": "Desktop",
  "connection.guide.tab.android": "Android",
  "connection.guide.android.tip": "Tip: Install Termux from F-Droid (not Play Store, which is outdated).",
  "connection.guide.step.copy": "Copy",
  "connection.guide.step.copied": "Copied!",
  "connection.guide.retry": "Try again",
  "connection.guide.footer": "The server runs on localhost:4096. After starting, the page connects automatically.",
  "connection.guide.step.installBun": "Install Bun",
  "connection.guide.step.cloneRepo": "Clone the repository",
  "connection.guide.step.enterDir": "Enter the directory",
  "connection.guide.step.installDeps": "Install dependencies",
  "connection.guide.step.startServer": "Start the server",
  "connection.guide.step.installTermux": "Install Termux (via F-Droid)",
  "connection.guide.step.installTermuxDeps": "Open Termux and install dependencies",
}
